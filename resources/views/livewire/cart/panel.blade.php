<div class="container-box-cart">
	{{-- Show full cart steps for authenticated users (force if step 1) --}}
	@if($step == 1 || auth('storefront')->check())
		{{-- Steps indicator --}}
	...
	{{-- Show login form for guest users (except for step 1) --}}
	@else
		<div class="py-10">
			<x-cart-card>
				<div class="card-body">
					<div class="container-box-auth content-wrapper">
						...
						<livewire:login-form :redirect-to-cart="true" />
