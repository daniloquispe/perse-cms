...
@section('title', "¡Hemos recibido tu pedido Nº {{ $order->number }}!")
...
@section('content')
	<div class="order-text-block">
		<div>
			...
			<div class="text">
				<p>Te confirmamos que tu pedido N&ordm; {{ $order->number }} ha sido recibido y se encuentra en proceso de aprobación, el cual tomará máximo 48 horas calendario.</p>
				<p>Quédate atento que apenas tu pedido sea aprobado te enviaremos un correo electrónico y un mensaje por WhatsApp. Ten en cuenta que aprobaremos el pedido una vez que el pago sea verificado.</p>
			</div>
		</div>
		<div>
			<x-icons.arrow-path />
	...
	<table>
		<tr>
			<td>
				...
				<h1>¡Hemos recibido tu pedido!</h1>
				<p>Te confirmamos que tu pedido N&ordm; {{ $order->number }} ha sido recibido y se encuentra en proceso de aprobación, el cual tomará máximo 48 horas calendario.</p>
				<p>Quédate atento que apenas tu pedido sea aprobado te enviaremos un correo electrónico y un mensaje por WhatsApp o SMS. Ten en cuenta que solo haremos el cobro del dinero una vez que la transacción sea aprobada. En caso de ser rechazada, no se realizará ningún cargo a tu tarjeta.</p>
			</td>
			<td>
