...
@section('title', '¡Tu pedido ha sido entregado!')
...
@section('content')
	<div class="order-text-block">
		<div>
			...
			<h1>¡Tu pedido fue entregado con éxito!</h1>
			<div class="text">
				<p>¡Tu pedido ha sido entregado con éxito! Tu pedido N&ordm; {{ $order->number }} ha sido entregado en la dirección solicitada.</p>
			</div>
		</div>
		<div>
			<x-icons.package />
