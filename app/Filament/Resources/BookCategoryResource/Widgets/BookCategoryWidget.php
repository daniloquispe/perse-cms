...
namespace App\Filament\Resources\BookCategoryResource\Widgets;
...
class BookCategoryWidget extends BaseWidget
{
    protected static string $model = BookCategory::class;

    protected static int $maxDepth = 3;

    protected ?string $treeTitle = 'Árbol de categorías';
